...
import UpdateYourProfile from "./Pages/UpdateProfile/UpdateYourProfile";
  ...
  return (
    <div className="App">
      ...
      <Switch>
        ...
        <Route 
        exact
        path="/user/edit-your-profile/:id"
        ...
        <Route exact path="/search-providers/:query" component={SearchProviders} />
        ...
        <Route exact path="/respond-to-job/:id" component={RespondToJob} />
        <Route exact path="/user/dashboard" component={UserDashboard} />
        <Route exact path="/user/message-detail/:id" render={()=> <MessageDetail socket={socket}/>} />
        <Route exact path="/user/payment-request" component={PaymentRequest} />
