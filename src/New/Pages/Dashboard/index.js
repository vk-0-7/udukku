					...
					>
						...
						<Box ml='1.14vw'>
							...
							<Text
								...
								w='47.9vw'
							>
								I am a rock, pop and RnB singer/songwriter with
								an experience of over 12 years. I have worked on
								various Western pop originals, and collaborated
								on covers with Universal Music India. My
								inspirations are various Indie musicians like
								Asees Kaur, Hasan Raheem, Jonita Gandhi and
								more. I aim to blend the western and Indian
								musical styles into one in my songs. I have a
								calm bassy voice and texture, and work well with
								songs having a western touch.
							</Text>
						</Box>
						<Box flexGrow={1}></Box>
						<Box
						...
						>
							<ExportIcon
								style={{ width: '1.45vw', height: '1.45vw' }}
							/>
							<Text
								fontSize={'.833vw'}
								fontFamily='Gilroy-SemiBold'
					...
					<Box mt='5.55vh'>
						...
						<Box mt='2.22vh'>
							{d_data.map((data, index) => {
								return (
									<JobSearchCard data={data} key={index} />
								);
							})}
						</Box>
					</Box>
