...
const Messages = () => {
    ...
    right: (
      <div style={{ display: "flex" }}>
        <p style={{ marginLeft: "auto" }}>
          Service Provider <Switch defaultChecked onChange={onChange} /> Client
        </p>
  ...
  const handleAttachment = (id) => {
    console.log(id);
    setLoading(true);
    axios.post("https://udukku.herokuapp.com/chatroom/get-attachments-by-id", { chatroomId: id }).then((res) => {
      console.log(res);
                ...
                myResponse.status === "active"
                  ...
                  >
                    <div style={{ width: "15%" }}>
                      ...
                      <p className="text-center mls-3">{jobs.length != 0 ? jobs[index].jobPostedBy.name : ""}</p>
                    </div>
                    <div className="card-body">
                      <Link
                      ...
                      <span
                        ...
                        data-toggle="modal"
                        data-target=".bd-example-modal-lg"
                        onClick={() => handleAttachment(chatrooms[index]._id)}
                      >
                        Attachments
                      </span>
                    </div>
