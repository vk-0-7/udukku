...
import { getServiceProviderBySubService, filterServiceProvider } from "../Functions/user";
...
const SearchProviders = ({ match }) => {
    ...
    useEffect(() => {
        getServiceProviderBySubService(match.params.query.toString().trim()).then((res) => {
            setUser(res.data);
