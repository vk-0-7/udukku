...
import {
	getServiceProviderBySubService,
	filterServiceProvider,
} from '../Functions/user';
import { Link } from 'react-router-dom';

const SearchProviders = ({ match }) => {
	...
	useEffect(() => {
		getServiceProviderBySubService(match.params.query.toString().trim())
			.then((res) => {
				setUser(res.data);
			})
			...
			>
				...
				<div class='accordion dHIde  pb-5' id='accordionExample'>
					...
					>
						...
						>
							<i class='fa fa-filter mr-4' aria-hidden='true'></i>{' '}
							Filters
						</h2>
						<div
							id='collapseTwo'
								...
								<div className='col-12 dHIde'>
									<div className='card mb-3 service-provider-card'>
										<div className='row'>
											...
											<div
												className='col-8 profile-card-width'
