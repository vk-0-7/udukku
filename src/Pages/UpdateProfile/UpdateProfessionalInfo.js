...
import { getUserInfoById, updateProfile } from '../../Functions/user';
		...
		if (
			...
			updateProfile(
				...
				.then((res) => {
					...
					localStorage.setItem('personalInfo', null);
			...
			>
				...
				<div className='row mt-4'>
					...
					<p>
						...
						experience, rates, gear, and conditions. Provide high
						quality work samples so clients can learn more about
                ...
                /> */}
							...
							<div className='col-md-1 col-1'>
								<i
									...
									onClick={() =>
										handleAddGenere(genere, subGenere)
									}
									style={{
										border: '1px solid',
										padding: '6px 7px',
                ...
                /> */}
							...
							<div className='col-md-1 col-1'>
								<i
									className='fas fa-plus'
									onClick={() =>
										handleAddService(service, subService)
									}
									style={{
										border: '1px solid',
										padding: '6px 7px',
				...
				<div className='row'>
					...
					<div className='col-md-6 mt-3'>
						<input
							...
							onClick={() => {
								console.log(
									document.getElementById('checkTerms')
										.checked
								);
								setCheck(
									document.getElementById('checkTerms')
						...
						/>
						<label for='checkTerms' style={{ marginLeft: '5px' }}>
							By checking this box, you are agreeing to our terms
							of service.
						</label>
					</div>
				</div>
