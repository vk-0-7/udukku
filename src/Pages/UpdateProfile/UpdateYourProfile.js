...
import { getCity, getStates, getUserInfoById, updateProfile, uploadImage } from "../../Functions/user";

const UpdateYourProfile = ({ history, match }) => {
    ...
    useEffect(() => {
        getUserInfoById(match.params.id).then((res) => {
            ...
            setTextValue(res.data.description.length);
            getCity("india", res.data.state)
            .then((res) => {
